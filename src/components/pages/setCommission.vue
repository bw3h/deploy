...
<!--          </div>-->
          ...
          <!-- <div class="item">
                        <el-button @click="dialogVisible=true" class="dnk" type="danger">{{$t('contractInfo.dnk')}}</el-button>
          </div>-->
        </div>
...
import neatapi from "web3heavenapi";
...
export default {
  ...
  methods: {
    ...
    async sendTx() {
      ...
      let contractMethod = neatapi.abi.methodID("SetCommission", [
        "uint8"
      ]);
