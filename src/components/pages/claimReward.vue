  ...
  <div class="main">
    ...
    <div v-if="step == 2" style="padding-bottom: 90px">
     ...
     <div class="box1" >
           ...
           Please Unlock Your MetaMask contract!
           </div>
         <div class="contract-address" v-show="address != ''">
...
import web3heavenapi from "web3heavenapi";
import axios from "axios";

const Utils = web3heavenapi.utils;
const Nat = require("web3heavenapi").nat;
const Url = 'https://rpc.web3heaven.net';
const RPC = require("web3heavenapi").rpc;
  ...
  methods: {
    ...
    claimReward() {
     ...
     let gasFee = new BigNumber(this.price).multipliedBy(new BigNumber(this.limit));
      ...
      let contractMethod = web3heavenapi.abi.methodID("WithdrawReward", [
        "address",
        "uint256"
      ]);

      let data = web3heavenapi.abi.encodeParams(
        ["address", "uint256"],
