export default {
    ...
    token: "Token",
    accesscontract: 'How to access your contract?',
    privatekey: 'Private key',
    selectKeyStoreFile: 'Please select your contract Keystore file',
    selectKeyStore: 'Please select your contract Keystore',
    etKeyStore: 'Please enter your contract Keystore',
    etcontractPwd: 'Please enter your contract password',
    unlock: 'Unlock',
    etPrivakey: 'Please enter your contract private key',
    ...
    etnpwd: 'Please select a new contract Keystore',
    etnpwd2: 'Please select a new contract Keystore',
    yAddr: 'contract Address',
    balance: 'Balance',
    ...
    etcontractName: 'Please enter contract name',
    contractPwd: 'contract Password',
    ...
    etcontractPwd: 'Please enter your contract password',
    repeatcontractPwd: 'Please repeat your contract password',
    etRepeatcontractPwd: 'Please repeat your contract password again',
    ...
    warn3: 'The downloaded file contains your contract information and do not share it with others or your asset will be stolen',
    ...
    confirm: 'Confirm',
    cancel: 'Cancel',
    mNum: 'Staking amount must be number',
    gt0: 'Staking amount must be greater than 0',
    ...
    rewardNumber: 'AMOUNT MUST BE A NUMBER',
    rewardGt: 'AMOUNT MUST BE GREATER THAN 0',
    rewardNotEnough: 'NOT ENOUGH COINS',
    tips: 'Reminder!',
    ...
    receiveAddr: 'Receive Address(web3heaven 3.0 Address)',
    ...
    nav: {
        ...
        guide: 'User Guide',
        community: 'Community',
        placeholder: 'contract ADDRESS / BLOCK NUMBER / TRANSACTION HASH',
        blockchain: {
            name: 'Blockchain',
            block: 'Blocks',
